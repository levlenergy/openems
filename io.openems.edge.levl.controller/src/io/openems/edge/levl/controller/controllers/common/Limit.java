...
public record Limit(int minPower, int maxPower) {
    ...
    /**
     * A class representing a memento of a limit with a minimum and maximum power.
     */
    ...
    /**
     * Returns a new LimitMemento with the minimum and maximum power of this Limit.
     *
     * @return a new LimitMemento
     */
    ...
    /**
     * Returns a new Limit with the minimum and maximum power of the given LimitMemento.
     *
     * @param memento the LimitMemento
     * @return a new Limit
     */
