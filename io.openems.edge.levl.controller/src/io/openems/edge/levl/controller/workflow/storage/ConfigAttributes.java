...
public enum ConfigAttributes {
    ...
    TOTAL_DISCHARGE_ENERGY_WS_AT_BATTERY_SCALED_WITH_EFFICIENCY("total_discharge_energy_ws_at_battery_scaled_with_efficiency"),
    ...
    GRID_POWER_LIMIT_W_LOWER("grid_power_limit_w_lower"),
    GRID_POWER_LIMIT_W_UPPER("grid_power_limit_w_upper"),
    ...
    NEXT_DISCHARGE_POWER_W("next_discharge_power_w"),
    ACTUAL_LEVL_POWER_W("actual_levl_power_w");
