...
class DischargeStateTest {
    ...
    private static final DischargeRequest FIRST_REQUEST = DischargeRequest.of(NOW, FIRST_REQUEST_TIMESTAMP, "Req01", 1000, DELAY_START_SECONDS, DURATION_SECONDS);
    private static final DischargeRequest FIRST_REQUEST_WITH_OTHER_VALUES = DischargeRequest.of(NOW, FIRST_REQUEST_TIMESTAMP, "Req01", 2000, 0, 7600);
    private static final DischargeRequest SECOND_REQUEST = DischargeRequest.of(NOW, SECOND_REQUEST_TIMESTAMP, "Req02", 2000, SECOND_DELAY_START_SECONDS, DURATION_SECONDS);
    private static final DischargeRequest NEW_REQUEST = DischargeRequest.of(NOW, NEW_REQUEST_TIMESTAMP, "Req03", 2002, SECOND_DELAY_START_SECONDS + 10, DURATION_SECONDS);
    ...
    void registerNewRequest_FirstRequest() {
        underTest = DischargeStateTestBuilder.Default().build();
        expected = DischargeStateTestBuilder.Default()
                .withNextRequestEfficiencyPercent(NEXT_REQUEST_EFFICIENTY_PERCENT)
                .withNextRequest(FIRST_REQUEST)
                .build();

        underTest.handleReceivedRequest(NEXT_REQUEST_EFFICIENTY_PERCENT, FIRST_REQUEST);

        assertThat(underTest).usingRecursiveComparison().isEqualTo(expected);
    }
    ...
    void registerNewRequest_SecondRequestOverwritesFirstRequest() {
        ...
        underTest.handleReceivedRequest(BigDecimal.TEN, FIRST_REQUEST);
        underTest.handleReceivedRequest(NEXT_REQUEST_EFFICIENTY_PERCENT, SECOND_REQUEST);
    ...
    void registerNewRequest_RequestWithSameId_NewRequestIsUsed() {
        ...
        underTest.handleReceivedRequest(BigDecimal.TEN, FIRST_REQUEST);
        underTest.handleReceivedRequest(NEXT_REQUEST_EFFICIENTY_PERCENT, FIRST_REQUEST_WITH_OTHER_VALUES);
    ...
    void registerNewRequest_FirstRequestIsActive_SecondRequestIsQueued() {
        DischargeState expected = DischargeStateTestBuilder.Default()
                ...
                .build();
        underTest = DischargeStateTestBuilder.Default()
                .withRequest(FIRST_REQUEST)
                .build();

        underTest.handleReceivedRequest(NEXT_REQUEST_EFFICIENTY_PERCENT, NEW_REQUEST);
    ...
    void update_nextRequestHasNotStartedYet() {
        ...
        underTest.update(NOW.plusSeconds(DELAY_START_SECONDS));
    ...
    void update_nextRequestShouldStart() {
        ...
        underTest.update(NOW.plusSeconds(DELAY_START_SECONDS + 1));
    ...
    void update_requestShouldContinueIfNotExpiredYet() {
        ...
        underTest.update(NOW.plusSeconds(DELAY_START_SECONDS + DURATION_SECONDS));
    ...
    void update_requestShouldCompleteIfExpired() {
        expected = DischargeStateTestBuilder.Default()
                ...
                .withCurrentEfficiencyPercent(DEFAULT_EFFICIENCY_PERCENT)
                .build();
        underTest = DischargeStateTestBuilder.Default()
                .withCurrentEfficiencyPercent(CURRENT_REQUEST_EFFICIENTY_PERCENT)
                .withRequest(FIRST_REQUEST)
                .withCurrentRequestRealizedDischargeEnergyWs(FIRST_REQUEST.getDischargeEnergyWs())
                .build();

        underTest.update(NOW.plusSeconds(DELAY_START_SECONDS + DURATION_SECONDS + 1));
    ...
    void update_requestShouldStartNextRequestIfNextRequestShouldStart() {
        ...
        underTest.update(NOW.plusSeconds(SECOND_DELAY_START_SECONDS + 1));
    ...
    void initAfterRestore_bothRequestsExpired() {
        ...
        underTest.initAfterRestore(NOW.plusSeconds(SECOND_DELAY_START_SECONDS + DURATION_SECONDS + 1));
    ...
    void initAfterRestore_firstRequestActive() {
        expected = DischargeStateTestBuilder.Default()
                .withRequest(FIRST_REQUEST)
                .withCurrentRequestRemainingDischargeEnergyWs(FIRST_REQUEST.getDischargeEnergyWs())
                .withNextRequestEfficiencyPercent(CURRENT_REQUEST_EFFICIENTY_PERCENT)
                .withNextRequest(SECOND_REQUEST)
                .withCurrentEfficiencyPercent(CURRENT_REQUEST_EFFICIENTY_PERCENT)
                .withNextRequestEfficiencyPercent(NEXT_REQUEST_EFFICIENTY_PERCENT)
                .build();
        ...
        underTest.initAfterRestore(NOW.plusSeconds(DELAY_START_SECONDS + DURATION_SECONDS));
    ...
    void initAfterRestore_secondRequestActive() {
        ...
        underTest.initAfterRestore(NOW.plusSeconds(SECOND_DELAY_START_SECONDS + 1));
    ...
    void handleDischargePowerWs_shouldAdjustFieldValuesCorrectly_batteryIsBeingDischarged() {
        ...
        expected = DischargeStateTestBuilder.Default()
                .withRequest(FIRST_REQUEST)
                .withCurrentEfficiencyPercent(CURRENT_REQUEST_EFFICIENTY_PERCENT)
                .withCurrentRequestRealizedDischargeEnergyWs(CURRENT_REQUEST_REALIZED_DISCHARGE_ENERGY_WS + newRealizedPowerW)
                .withCurrentRequestRemainingDischargeEnergyWs(currentRequestRemainingDischargeEnergyWs - newRealizedPowerW)
                .withTotalRealizedDischargeEnergyWs(TOTAL_REALISED_DISCHARGE_ENERGY + newRealizedPowerW)
                .withTotalDischargeEnergyWsAtBatteryScaledWithEfficiency((long) (TOTAL_REALISED_DISCHARGE_ENERGY_WITH_EFFICIENCY + newRealizedPowerW / CURRENT_REQUEST_EFFICIENCY))
                .build();
        ...
        underTest.handleRealizedDischargePowerWForOneSecond(newRealizedPowerW);
    ...
    void handleDischargePowerWs_shouldAdjustFieldValuesCorrectly_batteryIsBeingCharged() {
        ...
        expected = DischargeStateTestBuilder.Default().
                ...
                .withCurrentEfficiencyPercent(CURRENT_REQUEST_EFFICIENTY_PERCENT)
                .withCurrentRequestRealizedDischargeEnergyWs(CURRENT_REQUEST_REALIZED_DISCHARGE_ENERGY_WS + newRealizedPowerW)
                .withCurrentRequestRemainingDischargeEnergyWs(CURRENT_REQUEST_REMAINING_DISCHARGE_ENERGY_WS - newRealizedPowerW)
                .withTotalRealizedDischargeEnergyWs(TOTAL_REALISED_DISCHARGE_ENERGY + newRealizedPowerW)
                .withTotalDischargeEnergyWsAtBatteryScaledWithEfficiency((long) (TOTAL_REALISED_DISCHARGE_ENERGY_WITH_EFFICIENCY + CURRENT_REQUEST_EFFICIENCY * newRealizedPowerW))
                .build();
        underTest = DischargeStateTestBuilder.Default()
                .withRequest(FIRST_REQUEST)
                .withCurrentEfficiencyPercent(CURRENT_REQUEST_EFFICIENTY_PERCENT)
    ...
    void handleDischargePowerWs_shouldAdjustFieldValuesCorrectly_batteryIsBeingChargedDischargedCharged() {
        ...
        underTest.handleRealizedDischargePowerWForOneSecond(900); // scaled: 1000
        underTest.handleRealizedDischargePowerWForOneSecond(-600); // scaled: -540
        underTest.handleRealizedDischargePowerWForOneSecond(90); // scaled: 100
    ...
    void handleDischargePowerWs_requestShouldCompleteIfSignChanged_Discharge() {
        ...
        expected = DischargeStateTestBuilder.Default()
                ...
                .withCurrentRequestRemainingDischargeEnergyWs(0)
                .withTotalRealizedDischargeEnergyWs(TOTAL_REALISED_DISCHARGE_ENERGY + newRealizedPowerW)
                .withTotalDischargeEnergyWsAtBatteryScaledWithEfficiency((long) (TOTAL_REALISED_DISCHARGE_ENERGY_WITH_EFFICIENCY + newRealizedPowerW / CURRENT_REQUEST_EFFICIENCY + 1))
                .withLastCompletedRequestTimestamp(FIRST_REQUEST_TIMESTAMP)
                .withLastCompletedRequestRealizedDischargeEnergyWs(CURRENT_REQUEST_REALIZED_DISCHARGE_ENERGY_WS + newRealizedPowerW)
                .build();
        underTest = DischargeStateTestBuilder.Default()
                .withCurrentRequestRemainingDischargeEnergyWs(600)
                .withRequest(FIRST_REQUEST)
                .withCurrentEfficiencyPercent(CURRENT_REQUEST_EFFICIENTY_PERCENT)
                .build();
    ...
    void handleDischargePowerWs_inactiveRequestShouldDoNothing() {
        ...
        underTest.handleRealizedDischargePowerWForOneSecond(300);
    ...
    void handleDischargePowerWs_doesNotGoBeyondZero() {
        ...
        underTest.handleRealizedDischargePowerWForOneSecond(newRealizedPowerW);
        underTest.handleRealizedDischargePowerWForOneSecond(100);
    ...
    void save() {
        DischargeState.DischargeStateMemento expected = new DischargeState.DischargeStateMemento(
                TOTAL_REALISED_DISCHARGE_ENERGY,
                TOTAL_REALISED_DISCHARGE_ENERGY_WITH_EFFICIENCY,
                CURRENT_REQUEST_REMAINING_DISCHARGE_ENERGY_WS,
                CURRENT_REQUEST_REALIZED_DISCHARGE_ENERGY_WS,
                100,
                CURRENT_REQUEST_EFFICIENTY_PERCENT,
                NEXT_REQUEST_EFFICIENTY_PERCENT,
        ...
        underTest = DischargeStateTestBuilder.Default()
                ...
                .withTotalDischargeEnergyWsAtBatteryScaledWithEfficiency(TOTAL_REALISED_DISCHARGE_ENERGY_WITH_EFFICIENCY)
                .withCurrentEfficiencyPercent(CURRENT_REQUEST_EFFICIENTY_PERCENT)
                .withNextRequestEfficiencyPercent(NEXT_REQUEST_EFFICIENTY_PERCENT)
                .withLastCompletedRequestRealizedDischargeEnergyWs(100)
                .withLastCompletedRequestTimestamp(NEW_REQUEST_TIMESTAMP)
                .build();

        DischargeState.DischargeStateMemento actual = underTest.save();
