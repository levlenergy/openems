...
@ObjectClassDefinition(//
		name = "Simulator Levl DataSource: CSV OneWeek Predefined", //
...
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Simulator Levl DataSource: CSV Predefined [{id}]";
}